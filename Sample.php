...
$reminderlayout = new PinLayout(PinLayoutType::GENERIC_PIN, 'Sample timline pin!', null, null, null, PinIcon::NOTIFICATION_FLAG);
...
//Create the pin
$pin = new Pin('sample-pin-1', (new DateTime('now')) -> add(new DateInterval('PT5M')), $layout);
